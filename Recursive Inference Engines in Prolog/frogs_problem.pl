...
:- module(frogs_problem, [ initial_state/1
                         , final_state/1
                         , operation/4
...
:- begin_tests(frogs_initial_state).
